...
- v0.0.60 (2026-06-21)
  ...
  - fix: deleting multiple files simultaneously calls a single api
  - fix: when a non-top window is closed and then reopened, it does not appear at the top
...
- v0.0.59 (2025-07-04)
  ...
  - fix: when moving files across partitions, copy first and then delete; if files are within the same partition, rename them to speed up the process
  - fix: website document prompts that Ghostscript needs to be installed to generate PDF thumbnails
...
- v0.0.58 (2025-06-03)
  ...
  - fix: the full screen preview of the Photo Viewer cannot be dragged
