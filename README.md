...
<img src="https://img.shields.io/badge/Package Size-909KB-success">
...
- `version field` in [./package.json](./package.json)
- `GAGU_VERSION` in [./gagu-back-end/src/shared/utils/constant.util.ts](./gagu-back-end/src/shared/utils/constant.util.ts)

2. Sync dependencies in [./gagu-back-end/package.json](./gagu-back-end/package.json) to [./package.json](./package.json).
